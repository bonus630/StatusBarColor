...
<xsl:stylesheet version="1.0"
  ...
  <!-- Since these elements use the frmwrk name space, they will not be executed when the XSLT is applied to the user config file -->
	<frmwrk:uiconfig>
		...
		<frmwrk:compositeNode xPath="/uiConfig/commandBars/commandBarData[@guid='43b00301-e203-c798-44e8-e2afb122b62e']"/>
  ...
  <xsl:template match="node()|@*">
	...
	<!-- Add the new menu item in object context menu after "Show/Hide object" menu item-->
	<xsl:template match="commandBarData[@guid='1056b8d8-9185-46ee-af8e-77c7ba383a4e']/menu/item[@guidRef='6154a087-059d-4d9c-bac4-836b9377af23']">
		...
		<xsl:if test="not(./item[@guidRef='28ef6590-9aa2-493a-9ddc-dd9955ed5ac3'])">
			<item guidRef="28ef6590-9aa2-493a-9ddc-dd9955ed5ac3"/>
		</xsl:if>
	</xsl:template>
  <!-- Put the Warpper control at the end of the 'standard command bar' -->
  <xsl:template match="commandBarData[@guid='43b00301-e203-c798-44e8-e2afb122b62e']/toolbar">
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
      <!-- Make sure we don't read the menu item it it already exists -->
      <xsl:if test="not(./item[@guidRef='997e3380-dd9b-478e-97da-93b69ff0cb17'])">
				<item guidRef="997e3380-dd9b-478e-97da-93b69ff0cb17"/>
			</xsl:if>
    </xsl:copy>
  </xsl:template>
